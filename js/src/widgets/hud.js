(function ($) {
  ...
  $.Hud.prototype = {
    ...
    template: $.Handlebars.compile([
      ...
      '{{#if showNextPrev}}',
      '<a class="mirador-osd-previous hud-control " tabindex="0">',
      '<span class="sr-only">previous page</span>',
      '<i class="fa fa-3x fa-chevron-left "></i>',
      '</a>',
      '{{/if}}',
      '<div class="mirador-osd-context-controls hud-container uk-margin-top">',
      '{{#if showAnno}}',
      '<div class="mirador-osd-annotation-controls">',
      '<a class="mirador-osd-annotations-layer hud-control" role="button" title="{{t "annotationTooltip"}}" aria-label="{{t "annotationTooltip"}}"  uk-tooltip="{{t "annotationTooltip"}}; pos: bottom-left" tabindex="0">',
      ...
      '<a class="mirador-manipulation-toggle hud-control" role="button" title="{{t "imageManipulationTooltip"}}" aria-label="{{t "imageManipulationTooltip"}}"  uk-tooltip="{{t "imageManipulationTooltip"}}; pos: bottom-left">',
      ...
      '</div>',
      '{{#if showNextPrev}}',
      '<a class="mirador-osd-next hud-control " tabindex="0">',
